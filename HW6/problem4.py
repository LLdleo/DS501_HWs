...
#-------------------------------------------------------------------------
'''
    Problem 4: Decision Tree (with continuous attributes)
...
class Node:
    '''
        Decision Tree Node (with continuous attributes)
        Inputs: 
...
class DT(Tree):
    ...
    def cutting_points(X,Y):
        '''
            Find all possible cutting points in the continuous attribute of X. 
    ...
    def best_threshold(X,Y):
        '''
            Find the best threshold among all possible cutting points in the continuous attribute of X. 
            Input:
                X: a list of values, a numpy array of int/float values.
                Y: a list of values, a numpy array of int/float/string values.
            Output:
